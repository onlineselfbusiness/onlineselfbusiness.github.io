                      ...
                      <table id="optionChainTable-indices" class="common_table w-100">
                        ...
                        if (obj.selectedStrike) {
                          ...
                          for (let i = 0; i < arr.length; i++) {
                            ...
                            if(SelectedScript == 'NIFTY' && niftyPE && niftyPE[SelectedExpiryDate]) {
...
//let spArr = ["16000"]//, "16100"]
let spArr = [//"10000", "10500", "10900",
  //"11000", "11100", "11200", "11300", "11400", "11500", "11600", "11700", "11800", "11900",
  //"12000", "12100", "12200", "12300", "12500", "12600", "12700", "12800", "12900",
  //"13000", "13100", "13200", "13300", "13400", "13500", "13800", "13850", "13900", "13950",

  //"14000", "14050", "14100", "14150", "14200", "14250", "14300", "14350", "14400", "14450",
  "14500", "14550", "14600", "14650", "14700", "14750", "14800", "14850", "14900", "14950",

  "15000", "15050", "15100", "15150", "15200", "15250", "15300", "15350", "15400", "15450",
  "15500", "15550", "15600", "15650", "15700", "15750", "15800", "15850", "15900", "15950",

  "16000", "16050", "16100", "16150", "16200", "16250", "16300", "16350", "16400",
  "16450", "16500", "16550", "16600", "16650", "16700", "16750", "16800", "16850", "16900", "16950",
  ...
  "19000", "19050", "19100", "19150", "19200", "19250", "19300", "19350", "19400", "19450", "19500", "19550",
  "19600", "19650", "19700", "19750", "19800", "19850", "19900", "19950",
...
let gridOptions = {
  ...
  columnDefs: [
    ...
    { headerName:'₹',field: "niftyPrice" ,filter: false, suppressMenu: true},
    { headerName:'Close ₹',field: "niftyClosePrice" ,filter: true, suppressMenu: true, headerTooltip: 'Nify Close Price'},
    {
      field: 'change',
    ...
    { field: "expiryDate" , filter: true, rowGroup: true, enableRowGroup: true, hide: true, rowGroupIndex: 1},
    { headerName:'Strike Price', field: "strikePrice" , filter: true, rowGroup: true, enableRowGroup: true, hide: true, rowGroupIndex: 2},
                  ...
                  for(let d=data.length-1;d>0; d--) {
                      ...
                      if(odata[TIMESTAMP] == n[0] && odata[CHANGE_IN_OI] > 10 && odata[LAST_TRADED_PRICE] >= price) {
                          ...
                          if(r == '👍') {
                            ...
                            for(let k=change.length-1; k>1; k--) {
                              if(change[k][1]>10) {
                                ...
                                dTemp = change.slice(k)
                                break;
                              }
                            }
                            change = dTemp.reverse()
                          } else  { //if(r == '₹')
                          ...
                          result.push({
                              ...
                              strikePrice: parseFloat(parseFloat(stArr[s]).toFixed(2)),
...
function filterResult() {
  ...
  let h = 'Total Rows ' + optionAllHistoryCalData.length + ' : (' + win + ' 👍' + ' / ' + loss + ' 🔻' + (waiting > 0 ? ' / ' + waiting + ' ₹ : ' : '') + ')'
  ...
  for(let i=0; i<sArr.length; i++) {
      ...
      if(nd.getTime() >= ed.getTime() && sArr[i+1]) {
        result.push({
              ...
              gapOpen: parseFloat(parseFloat((sArr[i][1] - sArr[i+1][4])).toFixed(2)),
              highLow: parseFloat(parseFloat((sArr[i][2] - sArr[i][3])).toFixed(2)),
          })
      } else {
          break;
      }
